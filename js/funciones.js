...
export function validar(objeto){
    //Object.values(objeto) regresa un array con los valores del objeto
    return !Object.values(objeto).every( input => input !== '');
    //Si todo los elementos cumplen la condicion regresa true y false  si almeno uno no cumple
}